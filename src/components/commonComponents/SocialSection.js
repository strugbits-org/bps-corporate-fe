                ...
                <ul className="list-blog-lets-get-social">
                    ...
                    <a href="blog-post.html" className="link-blog">
                      ...
                      <div className="container-text">
                        <h4 className="blog-title">
                          ...
                          Showcasing Our New Wooden Furniture
                          Collection
                        </h4>
                  ...
                  <li>
                    <a href="blog-post.html" className="link-blog">
                      ...
                      <div className="container-text">
                        <h4 className="blog-title">
                          A Toast to Tradition: An Autumn Affair at
                          Darioush Winery
                        </h4>
                        <p className="blog-text">
                          As the golden hues of early fall descend
                          upon the picturesque landscapes of Napa,
                          there’s no venue that encapsulates the
                          region’s beauty
                        </p>
                      </div>
                    </a>
                  ...
                  <li>
                    <a href="blog-post.html" className="link-blog">
                      ...
                      <div className="container-text">
                        <h4 className="blog-title">
                          A Taste Explosion: Event Design Extravaganza
                          at Boa Restaurant Beverly Hills
                        </h4>
                        <p className="blog-text">
                          Beverly Hills, renowned for its luxury and
                          panache, witnessed an unforgettable evening
                          that melded culinary wonders with unmatched
                          event
                        </p>
                      </div>
                    </a>
