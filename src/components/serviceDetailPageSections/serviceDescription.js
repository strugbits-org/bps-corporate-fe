              ...
              <li className="grid-item">
                <div className="content">
                  ...
                  <div className="container-text">
                    <h3 className="service-name split-words">Floral Design</h3>
                ...
                <div className="content">
                  ...
                  <div className="container-text">
                    ...
                    <p className="service-description">
                      ...
                      condimentum eget, malesuada vel nulla. Vestibulum a dolor
                      turpis. Pellentesque ut lorem auctor, scelerisque enim
                      luctus, eleifend sem. Aenean eu leo ut nulla facilisis
                      pellentesque non ac magna. Morbi nec molestie turpis.
                      Fusce eros turpis, euismod in enim vel, mollis lobortis
                      nisl. Vivamus velit est, dictum ut leo ultricies,
                      malesuada bibendum ex.
