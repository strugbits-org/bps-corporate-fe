function getFullImageURL(imageSRC, optimized = false) {
    if (imageSRC && (imageSRC.startsWith("wix:image://v1/") || imageSRC.startsWith("wix:vector://v1/"))) {
        ...
        return wixImageURL + trimmedURL + (optimized ? "/v1/fit/w_1000,h_1000,al_c,q_75,usm_0.66_1.00_0.01,enc_auto/compress.webp" : "");
    } else {
        return imageSRC;
    }
}
...
export function getFullImagePost(wix_url, optimized = false) {
    if (wix_url) {
        ...
        if (src && (src.startsWith("wix:image://v1/") || src.startsWith("wix:vector://v1/"))) {
            ...
            return wixImageURL + wixLocalURL + (optimized ? "/v1/fit/w_1000,h_1000,al_c,q_75,usm_0.66_1.00_0.01,enc_auto/compress.webp" : "");
        } else {
            return src;
        }
    }
