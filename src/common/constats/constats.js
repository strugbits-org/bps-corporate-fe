...
export const datagettouch = {
  p1: " From the beautiful simplicity of a single flower arrangement to the grandeur of a gala.",
  p2: "From intimate milestone events to corporate conventions.",
  p3: "Blueprint Studios is an all around solution to any occasion.",
  btntext: "Get In Touch ",
};

// studio section data start
export const dataStudio = {
  heading: "Studios",
  paragraph:
    " Discover the versatility of our 6 internal studios working both independently and in tendem to fulfill any requirements you might have.",
};
...
// Some of our project end

// People are saying start
export const peoplereviewdata = {
...
// Dream big secton data end   //////////

// Social section data start /////
...
export const newsletter = {
  title: "Newsletter:",
  desc: "Register your email and stay up to date with everything before anyone else.",
};
export const address = [
  {
    city: "Napa Valley",
    address1: "955 Vintage Ave",
    address2: " St. Helena, CA 94574",
    contact: {
      phone1: "P / 707742.7777",
      phone2: "F / 415.822.8844",
    },
  },
  {
    city: "Las Vegas",
    address1: "7900 W Sunset RD",
    address2: " Suite 400 ",
    address3: "Las Vegas, NV 89113",
    contact: {
      phone1: "P / 707742.7777"
    },
  },
  {
    city: "Napa Valley",
    address1: "352 Shaw RD ",
    address2: "S. San Francisco, CA 94080",
    contact: {
      phone1: "P / 707742.7777",
      phone2: "F / 415.822.8844",
    },
...
export const  Slider = [
  {
    ...
    desc1: "Every project is unique, ",
      desc2: "each event its own.",
